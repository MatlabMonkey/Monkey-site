...
export const JOURNAL_QUESTION_SET: QuestionDef[] = [
  ...
  { key: "meaningful_moment", question_type: "text", wording: "Most meaningful moment", description: "What moment felt most emotionally significant, and why? What did it reveal about what you care about?", display_order: 14, metadata: {} },
  { key: "cope_reframe", question_type: "text", wording: "If something was hard: cope / reframe (optional)", description: "What did you do that helped? What would you tell a friend in the same situation? What's a more useful framing than the first one your brain offered?", display_order: 15, metadata: {} },
  // Section 5 — Evaluation (Wins, Misses, Learning)
  { key: "wins_proud", question_type: "text", wording: "Wins / what you're proud of", description: "What did you accomplish (big or small)? What choice are you glad you made? What did you do today that aligns with the person you want to be?", display_order: 16, metadata: {} },
  { key: "misses_friction", question_type: "text", wording: "Misses / friction", description: "What didn't go as planned? Where did you waste time, avoid something, or act out of alignment?", display_order: 17, metadata: {} },
  { key: "lesson_next_time", question_type: "text", wording: "Lesson + next time (turn the miss into data)", description: "What's the lesson in one sentence? What will you do differently next time? (Keep it specific.)", display_order: 18, metadata: {} },
  // Section 6 — Forward-Looking (Behavior Change)
  { key: "tomorrow_priority", question_type: "text", wording: "Tomorrow's #1 priority", description: "If tomorrow only goes well in one way, what should it be? Phrase as an action, not a vibe.", display_order: 19, metadata: {} },
  { key: "implementation_intention", question_type: "text", wording: "Implementation intention (high leverage)", description: "\"If [time/situation], then I will [specific action].\" Example: \"If it's 9:00am, then I start deep work for 60 minutes (phone away).\"", display_order: 20, metadata: {} },
  { key: "looking_forward", question_type: "text", wording: "Something you're looking forward to", description: "What's one thing tomorrow has that you can savor in advance?", display_order: 21, metadata: {} },
  // Extras: rose / bud / thorn + workouts
  { key: "rose", question_type: "text", wording: "Rose", description: "Highlight of the day.", display_order: 22, metadata: {} },
  { key: "bud", question_type: "text", wording: "Bud", description: "Something you're looking forward to.", display_order: 23, metadata: {} },
  { key: "thorn", question_type: "text", wording: "Thorn", description: "Something that could have been better today.", display_order: 24, metadata: {} },
  {
    key: "workouts",
