      ...
      <div className="relative flex items-center justify-center min-h-screen p-6">
        <div className="text-center space-y-8 max-w-4xl mx-auto">
          ...
          <div className="mt-8 text-center">
            <Link href="/work" className="inline-flex items-center rounded-xl border border-[rgb(var(--border))] bg-[rgb(var(--surface)_/_0.55)] px-4 py-2 text-sm text-[rgb(var(--text-muted))] hover:text-[rgb(var(--text))] hover:bg-[rgb(var(--surface-2)_/_0.75)] transition-all">
              Examples of Work
            </Link>
          </div>

          <div className={`grid gap-6 mt-12 ${isAuthenticated ? "md:grid-cols-3" : "max-w-md mx-auto"}`}>
            {isAuthenticated && (
              <Link
                href="/dashboard"
