...
export default function OpsProjectIndexPage() {
  ...
  async function loadIndex() {
    ...
    try {
      ...
      setError(err instanceof Error ? err.message : "Failed to load ops index")
    } finally {
      setLoading(false)
    }
  }
              ...
              {activeProjects.map((project) => (
                ...
                >
                  ...
                  <div className="mt-4 flex items-center justify-between gap-2">
                    ...
                    <Link
                      href={`/ops/projects/${encodeURIComponent(project.project_key)}`}
                  ...
                  <Link
                    href={`/ops/projects/${encodeURIComponent(project.project_key)}#run-logs`}
              ...
              {archivedProjects.length === 0 ? (
                ...
                archivedProjects.map((project) => (
                  <div key={project.id} className="rounded-xl border border-slate-800 bg-slate-900/80 p-3 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                    <Link href={`/ops/projects/${encodeURIComponent(project.project_key)}`} className="text-left">
